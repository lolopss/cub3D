...
/*   Updated: 2023/11/29 17:24:11 by ldaniel          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (data->hit == 3 && data->anim == 1)
		data->ttp = &data->textures.anim1;
	else if (data->hit == 3 && data->anim == 0)
		data->ttp = &data->textures.anim2;
	else if (data->hit == 2)
